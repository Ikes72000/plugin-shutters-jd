...
function displaySettingsPanels(_eqLogicType = '') {
    ...
    switch (_eqLogicType) {
        case 'externalConditions':
            ...
            div += '<option value="5" selected>{{Détection incendie}}</option>';
            div += '<option value="4">{{Absence (fermeture volets)}}</option>';
            div += '<option value="3">{{Absence (gestion auto)}}</option>';
            div += '</select>';
            div += '</div>';
            div += '<div class="col-sm-1">';
            div += '<select type="text" class="eqLogicAttr form-control cursor" data-l1key="configuration" data-l2key="priorityCondition' + i + 'Enabled">';
            div += '<option value="0" selected>{{Non}}</option>';
            div += '<option value="1">{{Oui}}</option>';
            div += '</select>';
            div += '</div>';
            div += '<div class="col-sm-1">';
            div += '<select type="text" class="eqLogicAttr form-control cursor" data-l1key="configuration" data-l2key="priorityCondition' + i + 'Priority">';
            div += '<option value="0">{{Non définie}}</option>';
